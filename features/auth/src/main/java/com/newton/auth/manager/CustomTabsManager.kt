...
@Singleton
class CustomTabsManager @Inject constructor() {


    fun launchOAuthFlow(context: Context, authorizationUrl: String): Boolean {
        return try {
    ...
    private fun launchSystemBrowser(context: Context, authorizationUrl: String): Boolean {
        return try {

...
class OAuthRepositoryImpl @Inject constructor(
    ...
    override fun generatePKCEData(): PKCEData {
        return PKCEUtils.generatePKCEData()
    }
    ...
    override suspend fun getAuthorizationUrl(
        ...
        return safeApiCall(
            apiCall = {
                val response = oAuthApiService.getAuthorizationUrl(
    ...
    override suspend fun exchangeCodeForTokens(
        ...
        return safeApiCall(
            apiCall = {
                val response = oAuthApiService.exchangeCodeForTokens(
                    provider = provider.providerName,
